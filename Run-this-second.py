...
def scrape_hotel_data(url):
    try:
        ...
        try:
            ...
            rates_bookings = None
        print("Bookings.com Rate:", rates_bookings)
...
# Create a unique index to prevent duplications
mycol.create_index([("Hotel URL", pymongo.ASCENDING)], unique=True)

# Retrieve and update additional information for the initial database
docs = mycol.find({}, {"_id": 1, "Hotel URL": 1})
i = 1
